...
import com.lfsf.usuario.infrastructure.repository.EnderecoRepository;
import com.lfsf.usuario.infrastructure.repository.TelefoneRepository;
...
//        return usuarioConverter.paraUsuarioDTO(usuario);
    ...
    public EnderecoDTO cadastraEndereco(String token, EnderecoDTO dto) {
        ...
        //Como o token já foi validado, não precisaria dessa exceção acima, mas como estamos usando o Optional do JPA pro findByEmail, então precisamos usar
