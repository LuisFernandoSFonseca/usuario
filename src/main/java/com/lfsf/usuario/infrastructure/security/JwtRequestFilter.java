package com.lfsf.usuario.infrastructure.security;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private final com.lfsf.usuario.infrastructure.security.JwtUtil jwtUtil;
    private final UserDetailsService userDetailsService;

    // Construtor que inicializa as propriedades com instâncias fornecidas
    public JwtRequestFilter(com.lfsf.usuario.infrastructure.security.JwtUtil jwtUtil, UserDetailsService userDetailsService) {
